...
def generate_weekly_summary(id_class):
    ...
    data_py.summary.create("week", id_class)
    t2 = {}
    for i in t["idteam"]:
        if data_py.team.check_team(i["id_team"]):
            ...
            data_py.summary.write(i["id_team"], t4, "week", id_class)
            t2[i["id_team"]] = t4
            data_py.team.clear_team_errors(i["id_team"])
            data_py.team.clear_team_gives(i["id_team"])
    return t2
